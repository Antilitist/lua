...
NDefines.NGameplay.LEADER_SCIENTIST_LEADING_RESEARCH_FIELD_EXPERIENCE			= 8;
...
NDefines.NGameplay.CUSTOM_EMPIRE_SPAWN_CHANCE 			= 50;	-- Chance that an empire will be created from an existing template instead of randomly generated (10 = 1% chance)
...
NDefines.NGameplay.FEDERATION_FIRST_LEADER_YEARS	= 8;	-- Number of years the first leader gets to rule.
NDefines.NGameplay.FEDERATION_LEADER_ROTATION_YEARS	= 8;	-- Leader Rotation Years
...
NDefines.NCombat.COMBAT_BASE_DAYS_UNTIL_EMERGENCY_FTL 	= 2.0;	-- how many days a fleet should be in combat until they can emergency ftl